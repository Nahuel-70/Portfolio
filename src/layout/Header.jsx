  ...
  return (
    ...
    >
      <nav className="py-4">
        ...
        {/* Mobile Menu */}
        <div 
          className={`fixed top-0 right-0 h-full w-80 bg-dark-bg/95 backdrop-blur-xl border-l border-dark-border transform transition-transform duration-300 ease-in-out md:hidden ${
